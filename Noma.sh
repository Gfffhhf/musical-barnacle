...
DOCKER_CMD="docker run --rm -d --network host --privileged --name nomachine-xfce4 -e PASSWORD=123456 -e USER=mido --cap-add=SYS_PTRACE --shm-size=1g thuonghai2711/nomachine-ubuntu-desktop:windows10"
...
clear
sleep 10
figlet  "The Username Is : mido" -c  | lolcat -a
